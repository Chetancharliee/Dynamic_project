...
.style32 {font-size: 24px; font-family: Geneva, Arial, Helvetica; color: #FF0000; }
  ...
  <div class="header_blog">
    <div id="slider">
      ...
      <div id="slideshow">
        ...
        <div class="slider-item">
          <div class="text_item"> 
            <h1 class="style32">Cloud Computing...            </h1>
            <p align="justify" class="style33">A cloud server which stores and searches encrypted data on behalf of data users, multiple data owners who upload encrypted data to the cloud, and multiple data users who would like to retreive encrypted data containing certain keywords.</p>
