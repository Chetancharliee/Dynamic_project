...
try 
	{
            ...
            <table width="549" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0" align="center">
              <tr>
                <td width="142" height="36"><div align="center" class="style29 style32 style7">
              ...
              <tr>
                ...
                <td><input readonly="readonly"  name="textfield2" type="text" size="49" value="<%=s6%>" />
                </td>
              </tr>
			    <tr>
                <td height="36"><div align="center" class="style33">
                ...
                <td><input readonly="readonly"  name="textfield2" type="text" size="49" value="<%=s7%>" />
                </td>
              </tr>
			    <tr>
                <td height="36"><div align="center" class="style33">
                ...
                <td><input readonly="readonly"  name="textfield2" type="text" size="49" value="<%=s8%>" />
                </td>
              </tr>
              <tr>
