          ...
          <div class="blogcont" >
            ...
            <form action="U_RegisterAuthentication.jsp" method="post" id="" enctype="multipart/form-data">
              ...
              <table width="590" height="524" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="259" scope="row">
                    <div align="left">User Name (required) : </div></td>
                ...
                <tr>
                  <td scope="row">
                                      <label for="label">                    </label>                    <label for="label"><div align="left">Your Address : </div>
                  </label></td>
                  <td><textarea name="address" cols="45" id="address"></textarea></td>
                </tr>
                <tr>
                  <td scope="row">
                                      <label for="label">                    </label>                    <label for="label"><div align="left">Date of Birth (required) : </div>
                  </label></td>
                ...
                <tr>
                  <td scope="row">
                                      <label for="label">                    </label>                    <label for="label"><div align="left">Enter Pincode (required) : </div>
                  </label></td>
                  <td><input id="pincode" name="pincode" class="text" /></td>
                </tr>
                <tr>
                  <td scope="row">
                                      <label for="location">                    </label>                    <label for="location"><div align="left">Enter Location (required) : </div>
                  </label></td>
                  <td><input id="loc" name="location" class="text" /></td>
                </tr>
                <tr>
                  <td scope="row">
                                      <label for="label">                    </label>                    <label for="label"><div align="left">Select Profile Picture (required) : </div>
                  </label></td>
