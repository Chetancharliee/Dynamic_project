      ...
      <div id="slideshow">
        <div class="slider-item">
          <div class="text_item">
            ...
            <p align="justify" class="style30">We first propose the random traversal algorithm which makes the cloud server randomly traverse on index and returns different results for the same query, and in the meantime, it maintains the accuracy of queries unchanged for higher security.</p>
