        ...
        <div class="body_resize_bottom">
          <div class="blogcont" >
            ...
            <table width="589" border="2" cellpadding="0" style="border-collapse:collapse" cellspacing="0" align="center">
              <tr>
                <td width="24" height="31"><div align="center" class="style22"> ID </div></td>
                <td width="58"><div align="center" class="style22">User</div></td>
                <td width="120"><div align="center" class="style22">File Name </div></td>
                <td width="86"><div align="center" class="style22">Owner</div></td>
                <td width="118"><div align="center" class="style22">Status</div></td>
                <td width="167"><div align="center" class="style22">Date &amp; Time</div></td>
              </tr>
              <%
