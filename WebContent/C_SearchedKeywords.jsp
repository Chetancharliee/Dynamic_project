...
<div class="main">
  ...
  <div class="body">
    ...
    <div class="body_resize">
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            <h2>Top-K Searched Keywords </h2>
            <p>&nbsp;</p>
            <table width="589" border="2" cellpadding="0" style="border-collapse:collapse" cellspacing="0" align="center">
              <tr>
                <td width="136" height="31"><div align="center" class="style22">User</div></td>
                <td width="232"><div align="center" class="style22">Top K Keyword </div></td>
                <td width="211"><div align="center" class="style22">Top-K Searched </div></td>
              </tr>
              <%
      	...
      	try 
	{
      		...
      		String query="SELECT user,keyword,count(keyword) FROM search group by keyword,user order by count(keyword) desc"; 
