    ...
    <div class="body_resize">
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            <h2>Search   </h2>
            <p class="style6"><span class="style7"> Enter Document 's Keyword To Search On Document : </span>         
              <br />
            </p>
            <p class="infopost">&nbsp;</p>
            <p class="infopost">
		...
		if(rs1.next())
		{
			...
			else
			{
				...
				<tr>
				<th width="236" height="40" scope="row"><div align="left"><span class="style15"><span class="odd  style16">Enter Multi Keyword  : </span></span></div></th>
